...
We have shared the results of Fig. 1. in the *results* folder. As the all our results spans to terrabytes of files, we choose to share only the most substanitial results. Other results can be regenerated by our codes (please note that these are stochastic simulations!)
